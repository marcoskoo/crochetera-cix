...
export function AdminLoginModal() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Login OK: la cookie se seteó en la response. Confiamos en ella y
      // redirigimos al panel. Si por alguna razón la cookie no se guardó,
      // adminFetch lo detectará más adelante con un 401 real al hacer
      // llamadas admin, y mostrará el mensaje adecuado.
      setAdminAuthed(true)
      setLoginOpen(false)
